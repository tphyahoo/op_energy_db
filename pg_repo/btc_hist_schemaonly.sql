...
--
-- Name: blk_times; Type: TABLE; Schema: public; Owner: opdev
--

CREATE TABLE public.blk_times (
    blk_height integer,
    cbits_hex text,
...
ALTER TABLE public.blk_times OWNER TO opdev;

--
-- Name: chng_blk_time; Type: TABLE; Schema: public; Owner: opdev
--

CREATE TABLE public.chng_blk_time (
    blk_height integer,
    mean_blk_time double precision
);


ALTER TABLE public.chng_blk_time OWNER TO opdev;
